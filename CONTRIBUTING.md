...
**[Contributing guide](https://phptui-docs.netlify.app/contributing)**

Its source lives in [`docs/content/contributing.mdx`](docs/content/contributing.mdx). Conventions for AI coding agents working in this repository are in [`AGENTS.md`](AGENTS.md).
