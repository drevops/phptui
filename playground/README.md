...
| `17-output-*` | The output primitives - a titled box, the five status lines, and an aligned definition list - theme-drawn chrome for around a form run, dropping their colour when piped or redirected. | [`17-output-box.php`](17-output-box.php), [`17-output-status.php`](17-output-status.php), [`17-output-definitions.php`](17-output-definitions.php) |
