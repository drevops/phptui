 ...
 * reflect earlier answers; `->border()` frames the card and `->table()` renders
 * an aligned grid beneath it. Here the summary note echoes the item, and the
 * collected JSON carries only the field's value.
 *
 * Usage:
