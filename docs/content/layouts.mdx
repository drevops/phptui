...
```php
$p->layout(2);
$p->text('Order name');                         // above the grid
$p->panel('Fruit', $declare);                   // window-1
$p->panel('Vegetables', $declare);              // window-2
$p->markup('Crates are weighed at the bench.'); // below the grid
```
