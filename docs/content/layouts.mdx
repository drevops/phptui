...
[`playground/20-layouts-scrolling.php`](https://github.com/drevops/tui/blob/main/playground/20-layouts-scrolling.php) prints one grid three times: with the room it comes to, in a frame too short for it, and moved down three rows - carrying the panel's own rows along with the windows.
