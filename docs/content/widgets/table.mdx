...
keywords: ['table', 'grid', 'tabular', 'note', 'presentational', 'widget']
---
...
<p align="center">
  <ThemedImage sources={{light: useBaseUrl('/widget-table-light-animated.svg'), dark: useBaseUrl('/widget-table-dark-animated.svg')}} alt="Table widget" />
</p>
...
Runnable script: [`playground/02-widgets-table.php`](https://github.com/drevops/tui/blob/main/playground/02-widgets-table.php).
...
Each column sizes to its widest cell, and the whole grid is capped at the frame width - an over-wide table shrinks its widest columns and ellipsizes the clipped cells so its borders always stay whole. Cells are coerced to strings, so numbers and booleans need no pre-formatting, and any line breaks in a cell fold to a space so it stays a single row.
...
<table>
  ...
  <tr>
    ...
    <td><ThemedImage sources={{light: useBaseUrl('/widget-table-light-static.svg'), dark: useBaseUrl('/widget-table-dark-static.svg')}} alt="Table: Unicode + ANSI" /></td>
    <td><ThemedImage sources={{light: useBaseUrl('/widget-table-light-static-no-ansi.svg'), dark: useBaseUrl('/widget-table-dark-static-no-ansi.svg')}} alt="Table: Unicode + No ANSI" /></td>
  </tr>
  <tr>
    <td align="right"><strong>ASCII</strong></td>
    <td><ThemedImage sources={{light: useBaseUrl('/widget-table-light-static-ascii.svg'), dark: useBaseUrl('/widget-table-dark-static-ascii.svg')}} alt="Table: ASCII + ANSI" /></td>
    <td><ThemedImage sources={{light: useBaseUrl('/widget-table-light-static-ascii-no-ansi.svg'), dark: useBaseUrl('/widget-table-dark-static-ascii-no-ansi.svg')}} alt="Table: ASCII + No ANSI" /></td>
  </tr>
</table>
