 ...
 * buffer are each overridable, so a widget whose buffer is not a plain caret
...
trait CompletionCapableTrait {
   ...
   *
   * A candidate qualifies only when the buffer is non-empty, the widget is in a
  ...
  /**
   * Whether the widget's current state offers a completion at all.
   *
   * @return bool
