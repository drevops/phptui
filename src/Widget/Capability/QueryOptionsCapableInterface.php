...
/**
 * A widget whose candidate list is resolved from its live query.
 *
 * The widget owns the query, the cache and the displayed state; it never
...
interface QueryOptionsCapableInterface {
  ...
  /**
   * Turn the widget's candidates over to a query source.
   *
  ...
  /**
   * Whether the widget's candidates come from a query source at all.
   *
   * @return bool
