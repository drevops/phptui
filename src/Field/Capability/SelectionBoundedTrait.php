 ...
 *
 * Mirrors the number field's bounds check: an accept whose selection count
 ...
 * before it is reached. Composes onto a list-collecting field that accepts
 * through {@see \DrevOps\Tui\Field\AbstractField::accept()}.
 *
...
trait SelectionBoundedTrait {
   ...
   *
   * The wording lives here once so a field that layers its own accept checks
